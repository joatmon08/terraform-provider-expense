...
plugin:
	go build -o terraform-provider-expense
	cp terraform-provider-expense ~/.terraform.d/plugins/
...
testacc: fmtcheck
	EXPENSE_URL=http://localhost:5001 TF_ACC=1 go test $(TEST) -v $(TESTARGS) -timeout 120m
